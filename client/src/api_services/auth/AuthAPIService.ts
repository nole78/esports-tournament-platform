...
export const authApi: IAuthAPIService = {
  ...
  async register(username, email, password, fullName, picture, role) {
    return axios.post<AuthResponse>(`${BASE}/register`, { username, email, password, fullName, picture, role })
