...
export type TournamentRegistrationPayload = Pick<TournamentRegistrationDto, 'teamId' | 'tournamentId' | 'seed'>;
...
export interface ITournamentRegistrationAPIService {
    ...
    registerTournament(id: number, payload: TournamentRegistrationPayload): Promise<ApiResponse<TournamentRegistrationDto>>;
