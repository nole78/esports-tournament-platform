...
export const healthApi: IHealthAPIService = {
  ...
  getApiStatus: (t) => axios.get<ApiResponse<ApiHealthDto>>(`${BASE}health/api`, { headers: h(t) }).then(r => r.data).catch(e => fail(e)),
  runApiCheck: (t) => axios.get<ApiResponse<ApiHealthDto>>(`${BASE}health/api/check`, { headers: h(t) }).then(r => r.data).catch(e => fail(e)),
